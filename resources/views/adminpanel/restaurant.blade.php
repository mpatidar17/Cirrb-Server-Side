    ...
    <div id = 'add-restaurant-form'>
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          {{ Form::text('name',Input::old('name'),array('class'=>'form-control', 'id' => 'pwd','required'=>'required')) }}
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          {{ Form::text('phone',Input::old('phone'),array('class'=>'form-control', 'id' => 'pwd','required'=>'required')) }}
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
        {{ Form::label('email','Email:') }}
          {{ Form::email('email',Input::old('email'),array('class'=>'form-control', 'id' => 'pwd','required'=>'required')) }}
        </div>
      </div>
