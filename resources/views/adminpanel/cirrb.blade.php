        ...
        <div id="sidebar-wrapper">
            <nav id="spy">
                <ul class="sidebar-nav nav">
                    ...
                    <li>
                        <a href="{{ URL::to('/bulk-notifications') }}">
...
<script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        /*if(typeof(initDetailsMap) === typeof(Function)){  
    ...
    $(document).ready(function(){
          ...
          $('#show-add-admin').click(function(e){
        ...
        $("#edit-customer-btn,#edit-partner-btn,#edit-admin-btn").click(function(e){
              $(".field-show").toggle();
              $(".field-hide").toggle();
         });
    });
    ...
    function sendNotification(id,status){
      if( status == 1 ){
        return window.location='{{ URL::to("/notifications") }}/'+id;
      }else{
      
        alert("This User is currently Inactive, Please activate to send notifications");      
        return false;
