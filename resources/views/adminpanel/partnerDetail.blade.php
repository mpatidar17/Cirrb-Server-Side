...
{{ Form::open(array("url" => "/partners/$partner->id" ,'method'=> "PUT",'enctype'=>'multipart/form-data') ) }}
...
<div class="restaurant-result">
  ...
  <div class="row">  
    ...
    <div class="col-md-6">
      <span class="field-show"><img style="width: 200px;" src="{{ $partner->image }}"></span>
  ...
  <div class="row">  
    ...
    <div class="col-md-6">
      <span class="field-show">SR {{ $partner->cash_in_hand }}</span>
      {{ Form::text('balance',$partner->cash_in_hand,array('class'=>'form-control field-hide')) }}
    </div>
  </div>
  <hr>
  ...
  <div class="row">  
    ...
    <div class="col-md-6">
      <span class="field-show">% {{ $partner->commission }}</span>
      {{ Form::text('commission',$partner->commission , array('class'=>'form-control field-hide')) }}
    </div>
  </div> 
</div>
