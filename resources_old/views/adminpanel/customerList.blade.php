    ...
    <tbody>
      @foreach( $users as $user )
        ...
        <tr>
          ...
          <td><a href="javascript:void(0)" onclick="redirectMeCustomer('{{$user->id}}')">Show</a> | <a href="javascript:void(0)" onclick="deleteCustomer('{{$user->id}}')">Delete</a> | <a href='{{URL::to("/change-password/$user->id")}}'>Change Password</a><!-- New --> | <a href='{{ URL::to("/notifications/$user->id") }}'>Send Notification</a><!-- New --></td>
        </tr>
