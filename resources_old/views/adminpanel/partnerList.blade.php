    ...
    <tbody>
      @foreach( $partners as $partner )
        ...
        <tr>
          ...
          <td>SR {{ $partner->balance }}</td>
          <td>SR {{ $partner->order_limit }}</td>
          <td><a href='{{ URL::to("/partners/$partner->id") }}'>Show</a> | <a href="javascript:void(0)" onclick="deletePartner('{{$partner->id}}')">Delete</a> | <a href='{{URL::to("/change-password/$partner->id")}}'>Change Password</a><!-- New --> | <a href='{{ URL::to("/notifications/$partner->id") }}'>Send Notification</a><!-- New --></td>
        </tr>
