  ...
  */
  ...
  public function store(){
    ...
    if($validator->fails()){
      ...
      $partner->cash_in_hand = Input::get('balance');
      $partner->lat = 0;
      $partner->long = 0;
      $partner->device_token = "";
      $partner->device_type = "";
      $partner->cash_in_hand = 0;
      $partner->commission = Input::get('commission');
	...
	if(Input::hasFile('image')){
        ...
        $partner->image = URL::to("/images/$fileName");
